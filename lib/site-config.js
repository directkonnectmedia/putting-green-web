...
export const SITE = {
  brand: {
    ...
    tagline: 'Custom backyard putting greens, synthetic grass, and gravel installation in Phoenix, Arizona.',
  },
  ...
  location: {
    ...
    heroTagline: 'BACKYARD PUTTING GREENS \u2022 SYNTHETIC GRASS \u2022 GRAVEL \u2022 PHOENIX, ARIZONA',
